Summary
-------
This is the README file for OPatch 12.2.0.1.32, the Oracle Interim One-off
Patch Installer.
...
OPatch 12.2.0.1.32 can only be used for OUI based Oracle Homes. The OUI version
must be 12.*. OPatch has been updated to work with both OUI 12c to 21c homes.
